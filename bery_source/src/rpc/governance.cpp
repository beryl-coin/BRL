...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in beryl.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("beryl.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Beryl features */
    { "beryl",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "beryl",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "beryl",               "gobject",                &gobject,                true,  {} },
    { "beryl",               "voteraw",                &voteraw,                true,  {} },
