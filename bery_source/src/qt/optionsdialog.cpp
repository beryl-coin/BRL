    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BRL-light"), QVariant("light"));
    ui->theme->addItem(QString("BRL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BRL-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BRL-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BRL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BRL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BRL-traditional"), QVariant("trad"));
