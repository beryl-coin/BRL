    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  beryl-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Beryl in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BRL, 0.1 BRL, 1 BRL and 10 BRL -- sort of like the paper money you use every day.</li> \
