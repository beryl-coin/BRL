...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Beryl related functionality
...
/*
    ...
    allow endless transaction that would bloat Beryl and make it unusable. To
