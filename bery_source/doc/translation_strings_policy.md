...
This document provides guidelines for internationalization of the Beryl Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `beryl_en.ts` remains unchanged.
