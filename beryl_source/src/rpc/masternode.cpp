...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Beryl address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "beryl",               "masternode",             &masternode,             true,  {} },
    { "beryl",               "masternodelist",         &masternodelist,         true,  {} },
    { "beryl",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "beryl",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "beryl",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "beryl",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
