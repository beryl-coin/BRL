...
This mechanism has been integrated into Bitcore-Node-Beryl which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/berylpay/insight-api-beryl#web-socket-api](https://github.com/berylpay/insight-api-beryl#web-socket-api)
* API: [https://github.com/berylpay/insight-api-beryl#instantsend-transactions](https://github.com/berylpay/insight-api-beryl#instantsend-transactions)
...
By default, the Beryl Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Beryl Core daemon:
